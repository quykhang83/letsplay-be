...
public class FirebaseMessagingSnippets {
    public void sendToToken() throws FirebaseMessagingException, IOException {
        // [START send_to_token]
        // This registration token comes from the client FCM SDKs.
        // String registrationToken = Messaging.getAccessToken();
        String registrationToken = "ecz3CJerX_bccDbdTAPXJV:APA91bHtUtkpOHpiANoTFr9rklPljBIUoxL8Fa79TTbAtwFWpX3UgUlz-XzndkbRiSgTiTOGSNlGKtw729__-B97QKV6EjHmFgqRCVE6XCvRapATgI_Toru4oclEOHufnWMuI-1M6ZzF";
        System.out.println("RegistrationToken: " + registrationToken);

        // See documentation on defining a message payload.
        // Message message = Message.builder()
        //         .setNotification(Notification.builder()
        //                 .setTitle("ApproveMe ctu")
        //                 .setBody("A request needs to be resolved")
        //                 .build())
        //         .setToken(registrationToken)
        //         .build();

        // Message message = allPlatformsMessage();

        // Send a message to the device corresponding to the provided
        // registration token.
        String response = FirebaseMessaging.getInstance().send(allPlatformsMessage(registrationToken));
    ...
    public Message allPlatformsMessage(String registrationToken) {
        // [START multi_platforms_message]
        Message message = Message.builder()
                .setWebpushConfig(WebpushConfig.builder()
                .setNotification(new WebpushNotification(
                        "ApproveMe ctu",
                        "A request needs to be resolved",
                        "https://fms-laravel-images.s3.ap-southeast-1.amazonaws.com/images/logoAxonActive.png"))
                .setFcmOptions(WebpushFcmOptions.withLink("https://www.baeldung.com/spring-fcm"))
                .build())
                .setAndroidConfig(AndroidConfig.builder()
                        .setTtl(3600 * 1000)
                        .setNotification(AndroidNotification.builder()
